...
define( 'DB_NAME', 'cornerpharmacyah668' );
...
define('WPLOGIN_KEYWORD', 'resh0000');

/* Recatpcha Access Key */
/* Update it using a working google Private key */
define('RECAPTCHA_PRIVATEKEY', '6LePnNkcAAAAAHWdlaNQxCxbqalASkJP39wh9sNw');
/* Update it using a working google Site key */
define('RECAPTCHA_SITEKEY',  '6LePnNkcAAAAAA2tgynVW-MRbTXvF5VXBVzpfX91');
 ...
 */
$table_prefix = 'cornerpharmacyah668_';
